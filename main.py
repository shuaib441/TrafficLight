...
# Check if the pressed key is the 'Esc' key (27) or 'q', and close the window if true.
    if key == 27 or key == ord('q'):
        cv2.destroyAllWindows()

if __name__ == '__main__':

    path = os.path.abspath('..')+'\\TRAFFICLIGHT3\\light\\'
    #path="C:/Maitexa1/projects/safi/TrafficLight/light"
